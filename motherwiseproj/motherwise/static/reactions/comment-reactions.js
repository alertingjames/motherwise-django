...
(function($) {
	...
	$.fn.commentReactions = function(options) {
		...
		var faces 	= '<img src="/static/reactions/emojis/like.svg" class="comment-emoji" data-emoji-value="like" style="" />';

		faces = faces + '<img src="/static/reactions/emojis/love.svg" class="comment-emoji" data-emoji-value="love" style="" />';

		faces = faces + '<img src="/static/reactions/emojis/haha.svg" class="comment-emoji" data-emoji-value="haha" style="" />';

		faces = faces + '<img src="/static/reactions/emojis/wow.svg" class="comment-emoji" data-emoji-value="wow" style="" />';

		faces = faces + '<img src="/static/reactions/emojis/sad.svg" class="comment-emoji" data-emoji-value="sad" style="" />';

		faces = faces + '<img src="/static/reactions/emojis/angry.svg" class="comment-emoji" data-emoji-value="angry" style="" />';
		...
		// on click emotions
		$('.comment-emoji').on("click",function (e) {
		...
		function __ajax(control_id, value) {
		    ...
		    if ( settings.type == "comment" ) {
			    ...
			    updateCommentReaction(control_id, value);
