...
(function($) {
	...
	$.fn.facebookReactions = function(options) {
		...
		var faces 	= '<img src="/static/reactions/emojis/like.svg" class="emoji" data-emoji-value="like" style="" />';

		faces = faces + '<img src="/static/reactions/emojis/love.svg" class="emoji" data-emoji-value="love" style="" />';

		faces = faces + '<img src="/static/reactions/emojis/haha.svg" class="emoji" data-emoji-value="haha" style="" />';

		faces = faces + '<img src="/static/reactions/emojis/wow.svg" class="emoji" data-emoji-value="wow" style="" />';

		faces = faces + '<img src="/static/reactions/emojis/sad.svg" class="emoji" data-emoji-value="sad" style="" />';

		faces = faces + '<img src="/static/reactions/emojis/angry.svg" class="emoji" data-emoji-value="angry" style="" />';
		...
		function __ajax(control_id, value){
			...
			updateReaction(settings.postUrl, control_id, value);
